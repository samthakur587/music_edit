...
with gr.Blocks(title="Interactive Music Track Generator") as demo:
    ...
    with gr.Tab("2. Generate Section Variants"):
        with gr.Accordion("Generate Full Loop Variants", open=False):
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    full_loop_bars = gr.Slider(
                        label="Number of Bars", minimum=4, maximum=64, value=16, step=4
                    )
                    ...
                    generate_full_loop_btn = gr.Button(
                        "Generate Full Loop Variants", variant="primary"
                    )
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    select_full_loop_1_btn = gr.Checkbox(label="Select Variant 1")
                with gr.Column():
                    gr.Markdown("### Variant 2")
                    full_loop_variant2 = gr.Audio(label="Variant 2")
                    select_full_loop_2_btn = gr.Checkbox(label="Select Variant 2")

            with gr.Row():
                with gr.Column():
                    gr.Markdown("### Variant 3")
                    full_loop_variant3 = gr.Audio(label="Variant 3")
                    select_full_loop_3_btn = gr.Checkbox(label="Select Variant 3")
                with gr.Column():
                    gr.Markdown("### Variant 4")
                    full_loop_variant4 = gr.Audio(label="Variant 4")
                    select_full_loop_4_btn = gr.Checkbox(label="Select Variant 4")

        with gr.Accordion("Generate Intro Variants", open=False):
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    intro_bars = gr.Slider(
                        label="Number of Bars", minimum=4, maximum=64, value=8, step=4
                    )
                    intro_p = gr.Slider(
                        label="Variation Parameter (p)",
                        minimum=0,
                    ...
                    generate_intro_btn = gr.Button(
                        "Generate Intro Variants", variant="primary"
                    )
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    select_intro_1_btn = gr.Checkbox(label="Select Variant 1")

                with gr.Column():
                    gr.Markdown("### Variant 2")
                    intro_variant2 = gr.Audio(label="Variant 2")
                    select_intro_2_btn = gr.Checkbox(label="Select Variant 2")

            with gr.Row():
                with gr.Column():
                    gr.Markdown("### Variant 3")
                    intro_variant3 = gr.Audio(label="Variant 3")
                    select_intro_3_btn = gr.Checkbox(label="Select Variant 3")
                with gr.Column():
                    gr.Markdown("### Variant 4")
                    intro_variant4 = gr.Audio(label="Variant 4")
                    select_intro_4_btn = gr.Checkbox(label="Select Variant 4")

        with gr.Accordion("Generate buildup Variants", open=False):
            with gr.Row():
                with gr.Column(scale=1):
                    gr.Markdown("### buildup Parameters")
                    var1_bpm = gr.Slider(
                        label="BPM (Beats Per Minute)",
                        minimum=60,
                        maximum=180,
                    ...
                    generate_var1_btn = gr.Button(
                        "Generate buildup Variants", variant="primary"
                    )
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    select_var1_1_btn = gr.Checkbox(label="Select Variant 1")
                with gr.Column():
                    gr.Markdown("### Variant 2")
                    var1_variant2 = gr.Audio(label="Variant 2")
                    select_var1_2_btn = gr.Checkbox(label="Select Variant 2")

            with gr.Row():
                with gr.Column():
                    gr.Markdown("### Variant 3")
                    var1_variant3 = gr.Audio(label="Variant 3")
                    select_var1_3_btn = gr.Checkbox(label="Select Variant 3")
                with gr.Column():
                    gr.Markdown("### Variant 4")
                    var1_variant4 = gr.Audio(label="Variant 4")
                    select_var1_4_btn = gr.Checkbox(label="Select Variant 4")

        with gr.Accordion("Generate breakdown Variants", open=False):
            with gr.Row():
                with gr.Column(scale=1):
                    gr.Markdown("### breakdown Parameters")
                    var2_bpm = gr.Slider(
                        label="BPM (Beats Per Minute)",
                        minimum=60,
                        maximum=180,
                    ...
                    generate_var2_btn = gr.Button(
                        "Generate breakdown Variants", variant="primary"
                    )
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    select_var2_1_btn = gr.Checkbox(label="Select Variant 1")
                with gr.Column():
                    gr.Markdown("### Variant 2")
                    var2_variant2 = gr.Audio(label="Variant 2")
                    select_var2_2_btn = gr.Checkbox(label="Select Variant 2")

            with gr.Row():
                with gr.Column():
                    gr.Markdown("### Variant 3")
                    var2_variant3 = gr.Audio(label="Variant 3")
                    select_var2_3_btn = gr.Checkbox(label="Select Variant 3")
                with gr.Column():
                    gr.Markdown("### Variant 4")
                    var2_variant4 = gr.Audio(label="Variant 4")
                    select_var2_4_btn = gr.Checkbox(label="Select Variant 4")

        with gr.Accordion("Generate drop Variants", open=False):
            with gr.Row():
                with gr.Column(scale=1):
                    gr.Markdown("### drop Parameters")
                    var3_bpm = gr.Slider(
                        label="BPM (Beats Per Minute)",
                        minimum=60,
                        maximum=180,
                    ...
                    generate_var3_btn = gr.Button(
                        "Generate drop Variants", variant="primary"
                    )
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    select_var3_1_btn = gr.Checkbox(label="Select Variant 1")
                with gr.Column():
                    gr.Markdown("### Variant 2")
                    var3_variant2 = gr.Audio(label="Variant 2")
                    select_var3_2_btn = gr.Checkbox(label="Select Variant 2")

            with gr.Row():
                with gr.Column():
                    gr.Markdown("### Variant 3")
                    var3_variant3 = gr.Audio(label="Variant 3")
                    select_var3_3_btn = gr.Checkbox(label="Select Variant 3")
                with gr.Column():
                    gr.Markdown("### Variant 4")
                    var3_variant4 = gr.Audio(label="Variant 4")
                    select_var3_4_btn = gr.Checkbox(label="Select Variant 4")

        with gr.Accordion("Generate Outro Variants", open=False):
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    generate_outro_btn = gr.Button(
                        "Generate Outro Variants", variant="primary"
                    )
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    select_outro_1_btn = gr.Checkbox(label="Select Variant 1")
                with gr.Column():
                    gr.Markdown("### Variant 2")
                    outro_variant2 = gr.Audio(label="Variant 2")
                    select_outro_2_btn = gr.Checkbox(label="Select Variant 2")

            with gr.Row():
                with gr.Column():
                    gr.Markdown("### Variant 3")
                    outro_variant3 = gr.Audio(label="Variant 3")
                    select_outro_3_btn = gr.Checkbox(label="Select Variant 3")
                with gr.Column():
                    gr.Markdown("### Variant 4")
                    outro_variant4 = gr.Audio(label="Variant 4")
                    select_outro_4_btn = gr.Checkbox(label="Select Variant 4")
    ...
    select_full_loop_1_btn.change(
        fn=select_variant,
        inputs=[full_loop_type, full_loop_variant_1, gr.State(False)],
        outputs=[full_loop_status],
    )

    select_full_loop_2_btn.change(
        fn=select_variant,
        inputs=[full_loop_type, full_loop_variant_2, gr.State(False)],
        outputs=[full_loop_status],
    )

    select_full_loop_3_btn.change(
        fn=select_variant,
        inputs=[full_loop_type, full_loop_variant_3, gr.State(False)],
        outputs=[full_loop_status],
    )

    select_full_loop_4_btn.change(
        fn=select_variant,
        inputs=[full_loop_type, full_loop_variant_4, gr.State(False)],
        outputs=[full_loop_status],
    )
    ...
    generate_intro_btn.click(
        fn=generate_section_variants_handler,
        inputs=[intro_type, intro_bpm, intro_bars, intro_p],  # Fixed section type
        outputs=[
            intro_status,
            intro_variant1,
            intro_variant2,
    ...
    select_intro_1_btn.change(
        fn=select_variant,
        inputs=[intro_type, intro_variant_1, gr.State(False)],
        outputs=[intro_status],
    )

    select_intro_2_btn.change(
        fn=select_variant,
        inputs=[intro_type, intro_variant_2, gr.State(False)],
        outputs=[intro_status],
    )

    select_intro_3_btn.change(
        fn=select_variant,
        inputs=[intro_type, intro_variant_3, gr.State(False)],
        outputs=[intro_status],
    )

    select_intro_4_btn.change(
        fn=select_variant,
        inputs=[intro_type, intro_variant_4, gr.State(False)],
        outputs=[intro_status],
    )

    # buildup generation and selection
    var1_type = gr.State("buildup")
    generate_var1_btn.click(
        fn=generate_section_variants_handler,
        inputs=[var1_type, var1_bpm, var1_bars, var1_p],  # Fixed section type
        outputs=[
            var1_status,
            var1_variant1,
            var1_variant2,
    ...
    select_var1_1_btn.change(
        fn=select_variant,
        inputs=[var1_type, var1_variant_1, gr.State(False)],
        outputs=[var1_status],
    )

    select_var1_2_btn.change(
        fn=select_variant,
        inputs=[var1_type, var1_variant_2, gr.State(False)],
        outputs=[var1_status],
    )

    select_var1_3_btn.change(
        fn=select_variant,
        inputs=[var1_type, var1_variant_3, gr.State(False)],
        outputs=[var1_status],
    )

    select_var1_4_btn.change(
        fn=select_variant,
        inputs=[var1_type, var1_variant_4, gr.State(False)],
        outputs=[var1_status],
    )

    # breakdown generation and selection
    var2_type = gr.State("breakdown")
    generate_var2_btn.click(
        fn=generate_section_variants_handler,
        inputs=[var2_type, var2_bpm, var2_bars, var2_p],  # Fixed section type
        outputs=[
            var2_status,
            var2_variant1,
            var2_variant2,
    ...
    select_var2_1_btn.change(
        fn=select_variant,
        inputs=[var2_type, var2_variant_1, gr.State(False)],
        outputs=[var2_status],
    )

    select_var2_2_btn.change(
        fn=select_variant,
        inputs=[var2_type, var2_variant_2, gr.State(False)],
        outputs=[var2_status],
    )

    select_var2_3_btn.change(
        fn=select_variant,
        inputs=[var2_type, var2_variant_3, gr.State(False)],
        outputs=[var2_status],
    )

    select_var2_4_btn.change(
        fn=select_variant,
        inputs=[var2_type, var2_variant_4, gr.State(False)],
        outputs=[var2_status],
    )

    # drop generation and selection
    var3_type = gr.State("drop")
    generate_var3_btn.click(
        fn=generate_section_variants_handler,
        inputs=[var3_type, var3_bpm, var3_bars, var3_p],  # Fixed section type
        outputs=[
            var3_status,
            var3_variant1,
            var3_variant2,
    ...
    select_var3_1_btn.change(
        fn=select_variant,
        inputs=[var3_type, var3_variant_1, gr.State(False)],
        outputs=[var3_status],
    )

    select_var3_2_btn.change(
        fn=select_variant,
        inputs=[var3_type, var3_variant_2, gr.State(False)],
        outputs=[var3_status],
    )

    select_var3_3_btn.change(
        fn=select_variant,
        inputs=[var3_type, var3_variant_3, gr.State(False)],
        outputs=[var3_status],
    )

    select_var3_4_btn.change(
        fn=select_variant,
        inputs=[var3_type, var3_variant_4, gr.State(False)],
        outputs=[var3_status],
    )
    ...
    generate_outro_btn.click(
        fn=generate_section_variants_handler,
        inputs=[outro_type, outro_bpm, outro_bars, outro_p],  # Fixed section type
        outputs=[
            outro_status,
            outro_variant1,
            outro_variant2,
    ...
    select_outro_1_btn.change(
        fn=select_variant,
        inputs=[outro_type, outro_variant_1, gr.State(False)],
        outputs=[outro_status],
    )

    select_outro_2_btn.change(
        fn=select_variant,
        inputs=[outro_type, outro_variant_2, gr.State(False)],
        outputs=[outro_status],
    )

    select_outro_3_btn.change(
        fn=select_variant,
        inputs=[outro_type, outro_variant_3, gr.State(False)],
        outputs=[outro_status],
    )

    select_outro_4_btn.change(
        fn=select_variant,
        inputs=[outro_type, outro_variant_4, gr.State(False)],
        outputs=[outro_status],
    )
